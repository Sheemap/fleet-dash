...
<template>
      <input v-model="currentConfig.title" class="bg-slate-700 w-full mt-0 block text-center px-0.5 border-0 rounded-t-lg border-b-2 border-zinc-500 my-2 focus:ring-0 focus:border-zinc-300 focus:bg-slate-800 hover:bg-slate-800" type="text" placeholder="Title" @change="updateConfig" />
