...
<template>
  <div v-if="authenticated">
    <img v-if="authenticated" v-on:click="this.toggleContextMenu" class="my-3 mr-5 rounded-full cursor-pointer h-12 w-12" v-bind:src="portrait_url" alt="Character Portrait"/>
